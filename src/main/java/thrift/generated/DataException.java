...
public class DataException extends org.apache.thrift.TException implements org.apache.thrift.TBase<DataException, DataException._Fields>, java.io.Serializable, Cloneable, Comparable<DataException> {
  ...
  public @org.apache.thrift.annotation.Nullable String meaages; // optional
  ...
  @org.apache.thrift.annotation.Nullable
  public String getMeaages() {
    return this.meaages;
  }

  public DataException setMeaages(@org.apache.thrift.annotation.Nullable String meaages) {
  ...
  public int compareTo(DataException other) {
    ...
    lastComparison = Boolean.valueOf(isSetMeaages()).compareTo(other.isSetMeaages());
    if (lastComparison != 0) {
