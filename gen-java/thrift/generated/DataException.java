...
public class DataException extends org.apache.thrift.TException implements org.apache.thrift.TBase<DataException, DataException._Fields>, java.io.Serializable, Cloneable, Comparable<DataException> {
  ...
  private static final org.apache.thrift.protocol.TField MEAAGES_FIELD_DESC = new org.apache.thrift.protocol.TField("meaages", org.apache.thrift.protocol.TType.STRING, (short)1);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String meaages; // optional
  ...
  private static final _Fields optionals[] = {_Fields.MEAAGES,_Fields.CALL_STACK,_Fields.DATE};
  public static final java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
  static {
    java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.MEAAGES, new org.apache.thrift.meta_data.FieldMetaData("meaages", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public DataException(DataException other) {
    if (other.isSetMeaages()) {
      this.meaages = other.meaages;
    }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getMeaages() {
    return this.meaages;
  }

  public DataException setMeaages(@org.apache.thrift.annotation.Nullable java.lang.String meaages) {
    this.meaages = meaages;
    return this;
  }

  public void unsetMeaages() {
    this.meaages = null;
  }

  /** Returns true if field meaages is set (has been assigned a value) and false otherwise */
  public boolean isSetMeaages() {
    return this.meaages != null;
  }

  public void setMeaagesIsSet(boolean value) {
    if (!value) {
      this.meaages = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case MEAAGES:
      if (value == null) {
        ...
        setMeaages((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(DataException that) {
    ...
    boolean this_present_meaages = true && this.isSetMeaages();
    boolean that_present_meaages = true && that.isSetMeaages();
    if (this_present_meaages || that_present_meaages) {
      if (!(this_present_meaages && that_present_meaages))
        return false;
      if (!this.meaages.equals(that.meaages))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetMeaages()) ? 131071 : 524287);
    if (isSetMeaages())
      hashCode = hashCode * 8191 + meaages.hashCode();
  ...
  public int compareTo(DataException other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMeaages()).compareTo(other.isSetMeaages());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMeaages()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.meaages, other.meaages);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetMeaages()) {
      sb.append("meaages:");
      if (this.meaages == null) {
        sb.append("null");
      } else {
        sb.append(this.meaages);
      }
      first = false;
    }
    if (isSetCallStack()) {
  ...
  private static class DataExceptionStandardScheme extends org.apache.thrift.scheme.StandardScheme<DataException> {
        ...
        switch (schemeField.id) {
          case 1: // MEAAGES
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.meaages = iprot.readString();
              struct.setMeaagesIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DataException struct) throws org.apache.thrift.TException {
      ...
      if (struct.meaages != null) {
        if (struct.isSetMeaages()) {
          oprot.writeFieldBegin(MEAAGES_FIELD_DESC);
          oprot.writeString(struct.meaages);
          oprot.writeFieldEnd();
        }
      }
