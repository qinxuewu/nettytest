...
public class PersonService {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Person recv_getPersonByUsername() throws DataException, org.apache.thrift.TException
    {
      ...
      if (result.dataEception != null) {
        throw result.dataEception;
      }
    ...
    public static class getPersonByUsername<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getPersonByUsername_args> {
      ...
      public getPersonByUsername_result getResult(I iface, getPersonByUsername_args args) throws org.apache.thrift.TException {
        ...
        try {
          ...
          result.dataEception = dataEception;
        }
        return result;
      }
    }
        ...
        return new org.apache.thrift.async.AsyncMethodCallback<Person>() { 
          ...
          public void onError(java.lang.Exception e) {
            ...
            if (e instanceof DataException) {
              result.dataEception = (DataException) e;
              result.setDataEceptionIsSet(true);
              msg = result;
  ...
  public static class getPersonByUsername_result implements org.apache.thrift.TBase<getPersonByUsername_result, getPersonByUsername_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPersonByUsername_result>   {
    ...
    private static final org.apache.thrift.protocol.TField DATA_ECEPTION_FIELD_DESC = new org.apache.thrift.protocol.TField("dataEception", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public @org.apache.thrift.annotation.Nullable DataException dataEception; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      SUCCESS((short)0, "success"),
      DATA_ECEPTION((short)1, "dataEception");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 0: // SUCCESS
            return SUCCESS;
          case 1: // DATA_ECEPTION
            return DATA_ECEPTION;
          default:
            return null;
        }
      }
    ...
    static {
      ...
      tmpMap.put(_Fields.DATA_ECEPTION, new org.apache.thrift.meta_data.FieldMetaData("dataEception", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public getPersonByUsername_result(
      Person success,
      DataException dataEception)
    {
      this();
      this.success = success;
      this.dataEception = dataEception;
    }
    ...
    public getPersonByUsername_result(getPersonByUsername_result other) {
      ...
      if (other.isSetDataEception()) {
        this.dataEception = new DataException(other.dataEception);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public DataException getDataEception() {
      return this.dataEception;
    }

    public getPersonByUsername_result setDataEception(@org.apache.thrift.annotation.Nullable DataException dataEception) {
      this.dataEception = dataEception;
      return this;
    }

    public void unsetDataEception() {
      this.dataEception = null;
    }

    /** Returns true if field dataEception is set (has been assigned a value) and false otherwise */
    public boolean isSetDataEception() {
      return this.dataEception != null;
    }

    public void setDataEceptionIsSet(boolean value) {
      if (!value) {
        this.dataEception = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case DATA_ECEPTION:
        if (value == null) {
          ...
          setDataEception((DataException)value);
        }
        break;
    ...
    public boolean equals(getPersonByUsername_result that) {
      ...
      boolean this_present_dataEception = true && this.isSetDataEception();
      boolean that_present_dataEception = true && that.isSetDataEception();
      if (this_present_dataEception || that_present_dataEception) {
        if (!(this_present_dataEception && that_present_dataEception))
          return false;
        if (!this.dataEception.equals(that.dataEception))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetDataEception()) ? 131071 : 524287);
      if (isSetDataEception())
        hashCode = hashCode * 8191 + dataEception.hashCode();
    ...
    public int compareTo(getPersonByUsername_result other) {
      ...
      lastComparison = java.lang.Boolean.valueOf(isSetDataEception()).compareTo(other.isSetDataEception());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDataEception()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataEception, other.dataEception);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public java.lang.String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("dataEception:");
      if (this.dataEception == null) {
        sb.append("null");
      } else {
        sb.append(this.dataEception);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class getPersonByUsername_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getPersonByUsername_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getPersonByUsername_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 1: // DATA_ECEPTION
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.dataEception = new DataException();
                struct.dataEception.read(iprot);
                struct.setDataEceptionIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPersonByUsername_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.dataEception != null) {
          oprot.writeFieldBegin(DATA_ECEPTION_FIELD_DESC);
          struct.dataEception.write(oprot);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
  ...
  public static class savePerson_result implements org.apache.thrift.TBase<savePerson_result, savePerson_result._Fields>, java.io.Serializable, Cloneable, Comparable<savePerson_result>   {
    ...
    public savePerson_result setDataEception(@org.apache.thrift.annotation.Nullable DataException dataEception) {
      this.dataEception = dataEception;
      return this;
    }
